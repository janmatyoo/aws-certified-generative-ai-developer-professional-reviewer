...
Amazon Q Business automatic content synchronization
- a feature that updates knowledge bases from source systems in real time
- security group mapping provides automatic access control based on existing enterprise roles
- this step uses built-in capabilities to maintain current content and enforce proper access controls
- this step does not require additional services or custom code. 
